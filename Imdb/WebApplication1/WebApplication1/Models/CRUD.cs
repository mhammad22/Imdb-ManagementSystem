...
namespace db_imdb.Models
{
    public class CRUD
    {
        // public static string connectionString = "data source=localhost; Initial Catalog=imdb1;Integrated Security=true";
        public static string connectionString = "data source=DESKTOP-V3VLIRR\\SQL; Initial Catalog=imdb1;Integrated Security=true"; 
        ...
        public static int addfeedback(string msg, string fname, string email)
        {
            SqlConnection con = new SqlConnection(connectionString);
            con.Open();
            SqlCommand cmd;
            ...
            try
            {
                cmd = new SqlCommand("addfeeback", con);
                cmd.CommandType = System.Data.CommandType.StoredProcedure;
                cmd.Parameters.Add("@msg1", SqlDbType.NVarChar, 1000).Value = msg;
                cmd.Parameters.Add("@name1", SqlDbType.NVarChar, 30).Value = fname;
        ...
        public static int updaterating_m(string rate, string tid)
        {
            SqlConnection con = new SqlConnection(connectionString);
            con.Open();
            SqlCommand cmd;
            ...
            try
            {
                cmd = new SqlCommand("updaterating_m", con);
                cmd.CommandType = System.Data.CommandType.StoredProcedure;
                cmd.Parameters.Add("@tid", SqlDbType.NVarChar, 30).Value = tid;
                cmd.Parameters.Add("@new_rate", SqlDbType.NVarChar, 30).Value = rate;
        ...
        public static int addtvshoww(String _id, String _title, String _noofseasons, String _release_date, String _genre, String _summary, String _rating, String _director)
        {
            ...
            try
            {
                cmd = new SqlCommand("TV_INSERT", con);
                cmd.CommandType = System.Data.CommandType.StoredProcedure;
                cmd.Parameters.Add("@id", SqlDbType.NVarChar, 30).Value = _id;
                cmd.Parameters.Add("@name", SqlDbType.NVarChar, 30).Value = _title;
        ...
        public static int deletetvshoww(String _id)
        {
            SqlConnection con = new SqlConnection(connectionString);
            con.Open();
            SqlCommand cmd;
        ...
        public static int deleteadminn(String _id, String _uid)
        {
            ...
            try
            {
                ...
                cmd.CommandType = System.Data.CommandType.StoredProcedure;
                cmd.Parameters.Add("@id", SqlDbType.NVarChar, 30).Value = _id;
                cmd.Parameters.Add("@uid", SqlDbType.NVarChar, 30).Value = _uid;
        ...
        public static int addnewss(String _id)
        {
            SqlConnection con = new SqlConnection(connectionString);
            con.Open();
            SqlCommand cmd;
            ...
            try
            {
                cmd = new SqlCommand("addnews", con);
                cmd.CommandType = System.Data.CommandType.StoredProcedure;
                cmd.Parameters.Add("@post", SqlDbType.NVarChar, 1000).Value = _id;
        ...
        public static int deletenewss(String _id)
        {
            SqlConnection con = new SqlConnection(connectionString);
            con.Open();
            SqlCommand cmd;
            ...
            try
            {
                cmd = new SqlCommand("deletenews", con);
                cmd.CommandType = System.Data.CommandType.StoredProcedure;
                cmd.Parameters.Add("@id1", SqlDbType.NVarChar, 1000).Value = _id;
        ...
        public static int addmovieactorr(String _id, String _movieid)
        {
            ...
            try
            {
                ...
                cmd.CommandType = System.Data.CommandType.StoredProcedure;
                cmd.Parameters.Add("@id", SqlDbType.NVarChar, 30).Value = _movieid;
                cmd.Parameters.Add("@actor1", SqlDbType.NVarChar, 30).Value = _id;
        ...
        public static int deletetvshowactorr(String _id, string _movieid)
        {
            SqlConnection con = new SqlConnection(connectionString);
            con.Open();
            SqlCommand cmd;
        ...
        public static List<Feedback> getfeedback()
        {
            ...
            try
            {
                cmd = new SqlCommand("getfeedback", con);
                cmd.CommandType = System.Data.CommandType.StoredProcedure;
                ...
                while (rdr.Read())
                {
                    Feedback movi = new Feedback();

                    movi.message = rdr["msg"].ToString();
                    movi.name = rdr["name"].ToString();
                    movi.email = rdr["mail"].ToString();
        ...
        public static List<User> getallusers()
        {
            ...
            try
            {
                cmd = new SqlCommand("getallusers", con);
                cmd.CommandType = System.Data.CommandType.StoredProcedure;
                ...
                while (rdr.Read())
                {
                    ...
                    movi.userId = rdr["id"].ToString();
                    movi.fname = rdr["fname"].ToString();
                    movi.lname = rdr["lname"].ToString();
                    movi.gender = rdr["gender"].ToString();
                    movi.password = rdr["pin"].ToString();
                    movi.country = rdr["country"].ToString();
                    movi.dob = rdr["dob"].ToString();
                    movi.email = rdr["email"].ToString();
                    movi.phoneno = rdr["phoneno"].ToString();
        ...
        public static List<News> getallnews()
        {
            ...
            try
            {
                cmd = new SqlCommand("getnews", con);
                cmd.CommandType = System.Data.CommandType.StoredProcedure;
                ...
                while (rdr.Read())
                {
                    News movi = new News();
                    movi.id= rdr["id"].ToString();
                    movi.date = rdr["post_date"].ToString();
                    movi.message = rdr["data"].ToString();
